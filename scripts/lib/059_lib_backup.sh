# 059_lib_backup.sh — Encrypted backup / restore / schedule for Grin Drop
# =============================================================================
...
# Grin Drop backup config — generated by 059_grin_drop.sh
...
#!/bin/bash
# Grin Drop daily backup — generated by 059_grin_drop.sh. Do not edit.
set -uo pipefail
...
dbk_schedule() {
    ...
    _dbk_write_wrapper
    cat > "$DBK_CRON" <<EOF
# Grin Drop daily backup — generated by 059_grin_drop.sh
