# 093_lib_server.sh — Grin Transporter server: deploy, nginx, tor, admin
# Sourced by 093_grin_transporter.sh — inherits colors/log/network variables
...
# Grin Transporter [$TRP_NET_LABEL] — generated by 093_grin_transporter.sh
