...
show_menu() {
    ...
    echo -e "  ${GREEN}1${RESET}) Solo PRIVATE mining   ${DIM}(one wallet, no payouts engine)${RESET}"
    echo -e "  ${GREEN}2${RESET}) Public mining pool    ${DIM}(GRINIUM — PPLNS, many miners, web UI)${RESET}"
    echo ""
